              ...
              >
                ...
                <div style={styles.metrics}>
                  <div style={styles.metric}>
                    ...
                    <span style={styles.metricValue}>{station.waitMin} mins</span>
                  </div>
                  <div style={styles.metric}>
                    <span style={styles.metricLabel}>Distance</span>
                    <span style={styles.metricValue}>{station.driveMin} min drive</span>
                  </div>
                </div>
              </button>
            );
...
const styles: Record<string, React.CSSProperties> = {
  ...
  metricLabel: { display: "block", fontSize: 10, color: "#94a3b8", marginBottom: 2 },
