...
const styles: Record<string, React.CSSProperties> = {
  ...
  cardTitle: { fontSize: 18.5, fontWeight: 800, margin: "0 0 4px" },
  refId: { fontSize: 13, opacity: 0.85, fontWeight: 500 },
  cardBody: {
    background: "#fff",
  ...
  rowSub: { fontSize: 13.5, color: "#64748b", margin: 0 },
  divider: {
    height: 1,
    background: "#f1f5f9",
    margin: "4px 0 14px",
  ...
  totalValue: { fontSize: 26, fontWeight: 800, color: "#2563eb" },
  confirmBtn: {
    width: "100%",
    padding: "13px 20px",
    background: "#2563eb",
